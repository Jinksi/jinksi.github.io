...
---
Initially, I intended to run the site as dynamic content, using Node.js & [Express](http://expressjs.com). But I instead used Node.js as a static site generator, spitting out html pages that I can then push to [Github Pages](http://pages.github.com) or [surge.sh](http://surge.sh/).
***
###### The Options
